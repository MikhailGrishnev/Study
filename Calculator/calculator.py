...
class Calculator(QWidget):
    def __init__(self):
        ...
        # for num in range(10):
        #         #     exec(f"self.b_{num} = QPushButton(\"{num}\", self)")
        #         #     exec(f"self.hbox_first.addWidget(self.b_{num})")
        ...
        # operations = {"plus": "+", "minus": "-", "multiply": "*", "divide": "/",  "ostatok": "%"}
        #          for operation, sign in operations.items():
        #             exec(f"self.b_{operation} = QPushButton(\"{sign}\", self)")
        #             exec(f"self.hbox_first.addWidget(self.b_{operation})")
        ...
        # for num in range(10):
        # exec(f"self.b_{num}.clicked.connect(lambda: self._button(\"{num}\"))")
